...
function ReleaseTicket({
  ...
  return (
    <button
      ...
      className="mt-2 w-full flex items-center justify-center gap-2 py-2 bg-red-100 text-red-700 rounded-lg hover:bg-red-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
    >
